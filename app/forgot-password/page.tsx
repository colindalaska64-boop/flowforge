        ...
        <div style={{ width:"100%", maxWidth:400 }}>
          ...
          {sent ? (
            <div className="glass-panel glass-shimmer" style={{ padding:"2rem", textAlign:"center" }}>
              ...
              <h2 style={{ fontSize:"1.1rem", fontWeight:800, marginBottom:".5rem", color:"#0A0A0A" }}>Email envoyé</h2>
              <p style={{ fontSize:".875rem", color:"#6B7280", lineHeight:1.7, marginBottom:"1.5rem" }}>
                Si un compte existe avec <strong style={{ color:"#0A0A0A" }}>{email}</strong>, vous recevrez un lien pour réinitialiser votre mot de passe.
              </p>
