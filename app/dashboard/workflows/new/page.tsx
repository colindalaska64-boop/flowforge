...
const nodeBlocks = {
  ...
  smart: [
    ...
    { type: "maillist_sub",  label: "Ajouter un abboné à la newsletter", desc: "Ajouter une adresse à une liste newsletter", icon: ListPlus, color: "#DC2626", bg: "#FEF2F2", border: "#FECACA" },
    { type: "maillist_snd",  label: "Envoyer un mail à la newsletter",   desc: "Envoyer un email aux abonnés d'une liste", icon: Mails, color: "#DC2626", bg: "#FEF2F2", border: "#FECACA" },
...
const iconMap: Record<string, React.ElementType> = {
  ...
  "Ajouter un abboné à la newsletter": ListPlus,
  "Envoyer un mail à la newsletter":   Mails,  
};
...
const styleMap: Record<string, { color: string; bg: string; border: string }> = {
  ...
  maillist_sub:  { color: "#DC2626", bg: "#FEF2F2", border: "#FECACA" },
  maillist_snd:  { color: "#DC2626", bg: "#FEF2F2", border: "#FECACA" },
};
