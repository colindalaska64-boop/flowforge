...
const plans = [
  {
    ...
    bg: "#F9FAFB",
    border: "#E5E7EB",
    features: ["100 tâches / mois","5 workflows actifs","Webhook, Gmail, Sheets","1 génération Kixi IA / mois","20 blocs IA / mois","Support communauté"],
  ...
  },
  {
    ...
    bg: "#EEF2FF",
    border: "#818CF8",
    features: ["2 000 tâches / mois","Workflows illimités","Toutes les intégrations","15 générations Kixi IA / mois","300 blocs IA / mois","Support email prioritaire"],
