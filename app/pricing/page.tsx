...
const plans = [
  {
    ...
    bg: "#F9FAFB",
    border: "#E5E7EB",
    features: ["100 tâches / mois","5 workflows actifs","Webhook, Gmail, Sheets","1 génération Kixi IA / mois","10 blocs IA / mois","Support communauté"],
    notIncluded: ["Slack, Notion, HTTP", "Support prioritaire"],
  ...
  },
  {
    ...
    bg: "#EEF2FF",
    border: "#818CF8",
    features: ["2 000 tâches / mois","Workflows illimités","Toutes les intégrations","15 générations Kixi IA / mois","150 blocs IA / mois","Support email prioritaire"],
    notIncluded: ["IA illimitée", "Support chat en direct"],
  ...
  },
  {
    ...
    bg: "#ECFDF5",
    border: "#34D399",
    features: ["50 000 tâches / mois","Workflows illimités","Toutes les intégrations","Kixi IA et blocs IA illimités","Historique 90 jours","Support dédié (réponse < 4h)","Onboarding personnalisé"],
    notIncluded: [],
