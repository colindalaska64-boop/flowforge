...
export default function Home() {
  ...
  const plans = [
    ...
    { name:"Pro", monthly:"19€", annual:"15€", desc:"Pour les PME et équipes en croissance.", features:["10 000 tâches / mois","Workflows illimités","100 générations Kixi IA / mois","2 000 blocs IA / mois","Blocs IA avancés inclus","Support chat en direct"], featured:false, cta:"Commencer →", ctaHref:"/register" },
    { name:"Business", monthly:"49€", annual:"39€", desc:"Pour les équipes et agences.", features:["50 000 tâches / mois","Workflows illimités","Kixi IA et blocs IA illimités","Support dédié < 4h","Onboarding personnalisé"], featured:false, cta:"Nous contacter", ctaHref:"mailto:loopflo.contact@gmail.com?subject=Plan Business LoopFlo" },
  ];
    ...
    <>
      ...
      <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:200, padding:"1rem 3rem", display:"flex", alignItems:"center", justifyContent:"space-between", background:"rgba(7,0,26,0.7)", backdropFilter:"blur(24px) saturate(180%)", WebkitBackdropFilter:"blur(24px) saturate(180%)", borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
        <div style={{ display:"inline-flex", alignItems:"center", gap:".55rem", fontWeight:900, fontSize:"1.2rem", letterSpacing:"-0.04em", color:"#fff" }}>
          <LogoMark size={30} variante="blanc" />
        ...
        <div style={{ maxWidth:"1100px", margin:"0 auto" }}>
          ...
          <div style={{ borderTop:"1px solid rgba(255,255,255,0.07)", paddingTop:"2rem", display:"flex", flexDirection:"column", gap:"1.5rem" }}>
            ...
            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:"1rem" }}>
              <span style={{ display:"inline-flex", alignItems:"center", gap:".5rem", fontSize:"1.1rem", fontWeight:900, color:"#fff", letterSpacing:"-0.04em" }}><LogoMark size={26} variante="blanc" /><span>Loop<span style={{ color:"#6366F1" }}>flo</span></span></span>
